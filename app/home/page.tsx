...
export default async function Page({
  ...
  const programmingLanguages =
    typeof searchParams.programmingLanguages === 'string'
      ? searchParams.programmingLanguages.split(',')
      : undefined;
  const usersTrying =
    typeof searchParams.usersTrying === 'string' ? searchParams.usersTrying : undefined;
  ...
  return <HomeView initialRewards={rewards} filters={filters} search={search} />;
}
