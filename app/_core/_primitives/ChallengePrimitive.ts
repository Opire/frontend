...
type ChallengePrimitivePropsToOmitForCreateChallengeDTO =
  | 'id'
  | 'creatorId'
  | 'participations'
  | 'isPublished'
  | 'isAcceptingParticipations'
  | 'isCompleted'
  | 'createdAt'
  | 'updatedAt';
export type CreateChallengeDTO = Omit<
  ChallengePrimitive,
  ChallengePrimitivePropsToOmitForCreateChallengeDTO
>;

type ChallengePrimitivePropsToOmitForEditDraftChallengeDTO =
  ChallengePrimitivePropsToOmitForCreateChallengeDTO;
export type EditDraftChallengeDTO = Omit<
  ChallengePrimitive,
  ChallengePrimitivePropsToOmitForEditDraftChallengeDTO
>;

type ChallengePrimitivePropsToOmitForEditPublishedChallengeDTO =
  | ChallengePrimitivePropsToOmitForCreateChallengeDTO
  | 'title'
  | 'summary'
  | 'mainObjetive'
  ...
  | 'contactInformation'
  | 'additionalComments';
export type EditPublishedChallengeDTO = Omit<
  ChallengePrimitive,
  ChallengePrimitivePropsToOmitForEditPublishedChallengeDTO
>;
