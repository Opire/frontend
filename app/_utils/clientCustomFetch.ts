  ...
  switch (error.errorType) {
    case 'ProgrammerPaymentAccountIsNotActivated':
      return {
        ...
        message:
          'Contact the programmer and ask them to activate their payment account, and try again after they are done',
      };
    ...
    case 'PaymentAccountNotFound':
      return {
        title: "The programmer doesn't have their payment account ready yet",
        message:
          'Contact the programmer, ask them to login into Opire to activate their payment account, and try again after they are done',
      };
    default:
      return {
        title: 'Ups...',
