...
export function ClaimerUserCard({ user, issueId, paidPrice, pendingPrice }: ClaimerUserCardProps) {
      ...
      >
        ...
        {haveToShowSomePrices && (
          <Group style={{ justifyContent: 'space-between' }}>
            {haveToShowPayButton && (
              <PayClaimerButton claimerId={user.id} issueId={issueId!} priceToPay={pendingPrice} />
            )}
            ...
            {paidPrice.value > 0 && (
              <Text component="div" size={'xs'} style={{ textAlign: 'center' }}>
                ...
                <Text style={{ fontSize: '0.8rem' }} c="dimmed">
