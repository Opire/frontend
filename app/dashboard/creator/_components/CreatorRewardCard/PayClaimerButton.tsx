...
export const PayClaimerButton: FC<PayButtonProps> = ({ claimerId, issueId, priceToPay }) => (
  <Button size={'md'} variant="gradient" onClick={() => handleClickPayClaimer(claimerId, issueId)}>
