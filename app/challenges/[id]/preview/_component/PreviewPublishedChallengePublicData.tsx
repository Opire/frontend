...
export const PreviewPublishedChallengePublicData: FC<PreviewPublishedChallengePublicDataProps> = ({
  challenge,
}) => (
  <Box>
...
const ParticipationsSection: FC = () => (
  <Center>
    <Card withBorder shadow="md" radius="md" w={'100%'}>
      ...
      <Center>
        <Button leftSection={<IconSend size={18} />} variant="light" onClick={() => {}}>
          Submit solution
        </Button>
      </Center>
      ...
      <Center>
        <Alert variant="light" color="blue" title="No participants yet" icon={<IconInfoCircle />}>
          <Text>No one has send their solution yet.</Text>

          <Text>
            If you want to complete the challenge, start working in your solution and send it when
            it&apos;s ready!
          </Text>
        </Alert>
      </Center>
