...
export function CompleteChallengeForm({
  challenge,
}: CompleteChallengeFormProps): React.ReactElement {
  ...
  async function completeChallenge() {
    try {
      ...
      await clientCustomFetch(API_ROUTES.CHALLENGES.COMPLETE(challenge.id), {
        method: 'POST',
      });
    ...
    <>
      ...
      >
        <Container size={'lg'}>
          ...
          >
            <Button onClick={closeCompleteChallengeModal} variant="subtle" size="md">
              Go back
            </Button>
