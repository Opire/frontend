...
export const PublishedChallengeCreatorActions: FC<PublishedChallengeCreatorActionsProps> = ({
  challenge,
}) => {
  const router = useRouter();
  const [
    isModalForToggleChallengeAcceptsParticipationsOpen,
    {
      close: closeModalForToggleChallengeAcceptsParticipations,
      open: openModalForToggleChallengeAcceptsParticipations,
    },
  ] = useDisclosure();
  ...
  return (
    <>
      <Flex>
        ...
        >
          {challenge.isAcceptingParticipations
            ? 'Disable new participations'
            : 'Enable new participations'}
        </Button>
      </Flex>
