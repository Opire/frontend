...
export function DeleteChallengeForm({
  ...
  isDisabled,
  isLoading,
}: DeleteChallengeFormProps): React.ReactElement {
        ...
        <Container size={'lg'}>
          ...
          >
            <Text>
              ...
              <strong>Once deleted, you will not be able to access to it</strong>, and it will be
            ...
            <Text>
              <strong>This cannot be undone</strong>, so make sure that you do not want to keep or
          ...
          >
            <Button onClick={closeDeleteChallengeModal} variant="subtle" size="md">
              Go back
            </Button>
