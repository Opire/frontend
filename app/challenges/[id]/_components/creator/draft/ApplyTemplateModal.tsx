...
export function ApplyTemplateModal({
  ...
  applyTemplate: (template: CreateChallengeTemplate) => void;
}): React.ReactElement {
    ...
    <>
      ...
      >
        <Container size={'lg'}>
          ...
          <Alert variant="light" color="yellow" title="Be careful!" icon={<IconInfoCircle />}>
          ...
          <div style={{ display: 'flex', justifyContent: 'end' }}>
            <Button onClick={onApplyTemplate} color="indigo" variant="filled">
