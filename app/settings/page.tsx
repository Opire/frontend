...
export default async function Page() {
  ...
  return (
    <Stack gap="xl">
      <section>
        <Text style={{ fontSize: '2.4rem', fontWeight: 'bold' }}>Install app</Text>
      ...
      <section>
        <Text style={{ fontSize: '2.4rem', fontWeight: 'bold' }}>Payments</Text>
      ...
      <section>
        <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'center' }}>
          <Text style={{ fontSize: '2.4rem', fontWeight: 'bold' }}>Tier</Text>
      ...
      {belongsToSomeOrganization && (
        <>
          ...
          <Text style={{ fontSize: '2.4rem', fontWeight: 'bold' }}>Your organizations</Text>

          <Group>
            <OrganizationsSettings organizations={userSettings.payments.organizations} />
          </Group>
        </>
      )}
