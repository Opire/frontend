...
export const OrganizationSettingsCard: FC<OrganizationSettingsCardProps> = ({ organization }) => {
    ...
    <>
      <Card shadow="xl" padding="xl">
        ...
        <Card.Section p="md">
          <Center>
            ...
            {isPayingSomeSubscription && (
              <OrganizationTiersStripeCurrentTier currentTier={currentTier} />
            )}
          </Center>
        </Card.Section>
      </Card>
      ...
      <Modal
        ...
        title={
          ...
          >
            <IconGift size={16} color="teal" />
            <span>
              Subscribe and get features for all members of{' '}
              <span style={{ fontWeight: 'bold', color: '#91a7ff' }}>{organization.name}</span>
            </span>{' '}
          </div>
        }
        closeOnEscape={false}
