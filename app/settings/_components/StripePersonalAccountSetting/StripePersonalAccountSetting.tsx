...
export const StripePersonalAccountSetting: FC<StripeSettingsProps> = ({
  ...
  const [
    isModalForNewAccountOpened,
    { open: openModalForNewAccount, close: closeModalForNewAccount },
  ] = useDisclosure(false);
          ...
          <Flex gap="1rem" wrap={'wrap'}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <Text
                  lineClamp={2}
                  style={{ fontSize: '0.6rem', lineHeight: 'normal' }}
                  c={'gray.4'}
                  ml="auto"
                >
                  Powered by{' '}
                  <span style={{ fontSize: '0.62rem', fontWeight: 'bold', color: '#06AB78' }}>
                    Zenvoice.io
                  </span>
                </Text>
                <Text
                  lineClamp={2}
                  style={{ fontSize: '1.2rem', lineHeight: 'inherit', marginBottom: '8px' }}
                >
                  Download invoices
                </Text>
              </div>
      ...
      <Modal
        ...
        title={
          ...
          >
            ...
            <span>Create a new Stripe Express account</span>
          </div>
        }
        closeOnEscape={true}
      ...
      >
        <form onSubmit={form.onSubmit(createExpressAccount)}>
          ...
          <Group justify="flex-end" mt="md">
            <Button type="submit" variant="gradient" size="md" loading={isCreatingExpressAccount}>
