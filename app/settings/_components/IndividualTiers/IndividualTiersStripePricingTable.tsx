...
export function IndividualTiersStripePricingPage({
  userId,
}: IndividualTiersStripePricingPageProps) {
  const pricingTableId =
    process.env.NEXT_PUBLIC_STRIPE_INDIVIDUAL_PRICING_TABLE_ID ?? 'prctbl_1PlDKsAiqyUpICJDbA2t0SD6';
